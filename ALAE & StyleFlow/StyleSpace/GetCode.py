...
if __name__ == "__main__":
    ...
    if args.code_type=='w':
        ...
        save_name='S'
        save_tmp=GetS(output_path,num_img=1_000)
        ...
        Gs=LoadModel(dataset_name=dataset_name)
        all_images=GetImg(Gs,num_img=2_000,num_once=num_once,output_path=output_path,resize=args.resize)
