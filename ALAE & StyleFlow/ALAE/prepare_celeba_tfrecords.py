...
def prepare_celeba(cfg, logger, train=True):
    ...
    with open("../CelebA/list_eval_partition.txt") as f:
    ...
    if spread_identiteis_across_folds:
        ...
        # 000001.jpg 2880
        # 000002.jpg 2937
        with open("../CelebA/Anno/identity_CelebA.txt") as f:
            lineList = f.readlines()
    ...
    for i in range(folds):
        ...
        tfr_opt = tf.io.TFRecordOptions(tf.io.TFRecordOptions(compression_type = ''))
