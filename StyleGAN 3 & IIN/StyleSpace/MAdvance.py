...
class MAdvance(Manipulator):
    ...
    def __init__(self,dataset_name, w_path, semantic_path):
        ...
        try:
            self.LoadSemantic(semantic_path)
    ...
    def LoadSemantic(self, semantic_path):
...
if __name__ == "__main__":
    ...
    M=MAdvance(dataset_name=dataset_name, w_path=w_path, semantic_path=semantic_path)
