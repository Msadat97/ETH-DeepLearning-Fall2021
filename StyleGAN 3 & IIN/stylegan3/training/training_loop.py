...
def save_image_grid(img, fname, drange, grid_size):
    ...
    if C == 3:
        ...
        image.save(fname)
    if "reals" in fname:
        wandb.log({"reals": wandb.Image(image)}, commit=False)
    else:
        wandb.log({"fakes": wandb.Image(image)}, commit=False)
    ...
    while True:
        ...
        if (snapshot_data is not None) and (len(metrics) > 0):
            ...
            for metric in metrics:
                ...
                if rank == 0:
                    # logging metric results to wandb api
                    wandb.log(result_dict, commit=False)
        ...
        if stats_jsonl is not None:
            ...
            stats_jsonl.flush()
            # logging training stats to wandb api
